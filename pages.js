...
function getPage ( numPage ) {
	...
	if (numPage == test++ ) return [
		'Le jeu Papier / Caillou / Ciseaux', 'JeuPCC',
	...
	if (numPage == test++ ) return [
		'Choix de l’ordinateur, choix fixe au départ', 'CDLOFAD',
	...
	if (numPage == test++ ) return [
		'Fonction pour le choix de l’ordinateur', 'FuncOrdi',
	...
	if (numPage == test++ ) return [
		'Modifier la fonction choixAleatoire()', 'NFCALe',
	...
	if (numPage == test++ ) return [
		'Distinguer entre caillou et ciseaux', 'DECCCis',
	...
	if (numPage == test++ ) return [
		'Afficher le résultat: qui a gagné', 'ALRQAG',
	...
	if (numPage == test++ ) return [
		'Afficher notre choix comme image au lieu de texte', 'ANCImg',
	...
	if (numPage == test++ ) return [
		'Montrer le choix de l’ordinateur aussi comme image', 'ImgCDLOrdi',
	...
	if (numPage == test++ ) return [
		'Changer l’affichage des images', 'ImgChgAffichage',
	...
	if (numPage == test++ ) return [
		'Garder un score des résultats', 'ScoreRes',
	...
	if (numPage == test++ ) return [
		'Une carte “Google Maps” dans notre page web', 'GMapsDNP',
