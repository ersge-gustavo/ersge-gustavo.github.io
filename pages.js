...
function getPage ( numPage ) {
	...
	if (numPage == test++ ) return [
		'Choix de l’ordinateur, choix fixe au départ',
	...
	if (numPage == test++ ) return [
		'Modifier la fonction choixAleatoire()',
	...
	if (numPage == test++ ) return [
		'Distinguer entre caillou et ciseaux',
	...
	if (numPage == test++ ) return [
		'Afficher le résultat: qui a gagné',
	...
	if (numPage == test++ ) return [
		'Afficher notre choix comme image au lieu de texte',
	...
	if (numPage == test++ ) return [
		'Montrer le choix de l’ordinateur aussi comme image',
	...
	if (numPage == test++ ) return [
		'Changer l’affichage des images',
	...
	if (numPage == test++ ) return [
		'Une carte “Google Maps” dans notre page web',
